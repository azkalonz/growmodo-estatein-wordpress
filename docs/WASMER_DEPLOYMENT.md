...
6. re-queries the current active app version, purges its InstaBoot snapshot, and restarts it so PHP reloads the published files;
7. checks the public theme stylesheet and site URL over HTTPS.
